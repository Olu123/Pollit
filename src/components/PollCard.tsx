...
export default function PollCard({ poll }: { poll: Poll }) {
  ...
  return (
    <article className="bg-card rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow duration-200 p-4 sm:p-5 flex flex-col gap-3.5">
      ...
      {/* Footer — 44 px min-height touch targets throughout */}
      <div className="mt-auto pt-3 border-t border-border flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="flex items-center justify-center w-11 h-11 rounded-full bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 active:bg-[#25D366]/30 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2"
          >
            <WhatsAppIcon />
          </a>
          {/* Vote — 44 px height */}
