...
export const metadata: Metadata = { title: 'Privacy — WéPollit' }
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 sm:px-6 py-16 flex flex-col items-center gap-4 text-center">
      ...
      <p className="text-sm text-muted-foreground max-w-md">
        ...
        WéPollit and never sell your data. Questions? <Link href="/contact" className="text-primary font-semibold">Contact us</Link>
      </p>
