    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10 flex flex-col gap-8 sm:gap-10">
      ...
      <section className="bg-gradient-to-br from-muted/60 to-card border border-border rounded-2xl p-5 sm:p-6 flex flex-col gap-3">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          {en
            ? 'WePollit started with 100,000,000 tokens. Every token distributed is logged in this public ledger. The reserve is simply:'
            : 'WePollit start with 100,000,000 tokens. Every token wey dem share dey logged for this public ledger. The reserve na just:'}
        </p>
...

{
  ...
  "generated_at": "${new Date().toISOString()}"
      ...
      <p className="text-xs text-muted-foreground text-center max-w-2xl mx-auto leading-relaxed">
        {en
          ? 'This data updates every 60 seconds. WePollit is committed to full transparency in its token economy. All transactions are permanent and cannot be deleted or modified.'
          : 'This data dey update every 60 seconds. WePollit promise say everything go dey open for everybody to see.'}
      </p>
    </main>
  )
}
